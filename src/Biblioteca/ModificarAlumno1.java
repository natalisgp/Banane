...
public class ModificarAlumno1 extends JFrame {
  ...
  public static void main(String[] args) {
    EventQueue.invokeLater(new Runnable() {
      public void run() {
        try {
        	ModificarAlumno1 frame = new ModificarAlumno1();
  ...
  public ModificarAlumno1() {
    ...
    try{
      String[] datos = funciones.getAlumno(ModificarAlumno.ndni);
      ...
      label_2.addMouseListener(new MouseAdapter() {
        ...
        public void mouseClicked(MouseEvent e) {
          ...
          ModificarAlumno1.this.dispose(); //hago "invisible la clase login"
        }
      });
      ...
      dnis.setText(ModificarAlumno.ndni);
