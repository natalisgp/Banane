...
public class ModificarProfe extends JFrame {
  ...
  public static void main(String[] args) {
    EventQueue.invokeLater(new Runnable() {
      public void run() {
        try {
        	ModificarProfe frame = new ModificarProfe();
  ...
  public ModificarProfe() {
    ...
    label_2.addMouseListener(new MouseAdapter() {
      ...
      public void mouseClicked(MouseEvent e) {
        ...
        ModificarProfe.this.dispose(); //hago "invisible la clase login"
      }
    });
        ...
        if(ndni.length()>0){ // y exista dicho dni
          ...
          try{
            ...
            if(ndni.equals(usuario[2])){
              ...
              new ModificarProfe1().setVisible(true);
              ModificarProfe.this.dispose();
