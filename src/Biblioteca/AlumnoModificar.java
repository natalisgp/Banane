...
public class AlumnoModificar extends JFrame {
  ...
  public static void main(String[] args) {
    EventQueue.invokeLater(new Runnable() {
      public void run() {
        try {
        	AlumnoModificar frame = new AlumnoModificar();
  ...
  public AlumnoModificar() {
    ...
    try{
      String[] datos = funciones.getAlumno(login.ndni);
      ...
      label_2.addMouseListener(new MouseAdapter() {
        ...
        public void mouseClicked(MouseEvent e) {
          ...
          AlumnoModificar.this.dispose(); //hago "invisible la clase login"
        }
      });
