...
public class ProfesorDatos extends JFrame {
  ...
  public static void main(String[] args) {
    EventQueue.invokeLater(new Runnable() {
      public void run() {
        try {
        	ProfesorDatos frame = new ProfesorDatos();
    ...
    try{
      ...
      label_2.addMouseListener(new MouseAdapter() {
        ...
        public void mouseClicked(MouseEvent e) {
          ...
          ProfesorDatos.this.dispose(); //hago "invisible la clase login"
        }
      });
      ...
      JLabel lblEliminarUsuario = new JLabel("Ver datos del profesor");
