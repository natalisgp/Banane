...
public class BiblioModiAlumno1 extends JFrame {
  ...
  public static void main(String[] args) {
    EventQueue.invokeLater(new Runnable() {
      public void run() {
        try {
          BiblioModiAlumno1 frame = new BiblioModiAlumno1();
   ...
   * Create the frame.
   */
  public BiblioModiAlumno1() {
    
    try{
      String[] datos = funciones.getAlumno(BiblioModiAlumno.ndni);
      ...
      label_2.addMouseListener(new MouseAdapter() {
        ...
        public void mouseClicked(MouseEvent e) {
          ...
          BiblioModiAlumno1.this.dispose(); //hago "invisible la clase login"
        }
      });
      ...
      dnis.setText(BiblioModiAlumno.ndni);
      
      JLabel lblEliminarUsuario = new JLabel("Modificar datos del alumno");
        ...
        public void actionPerformed(ActionEvent e) {
          ...
          if(nnombre.length()>0 && napellidos.length()>0 && nusername.length()>0 && npermisos.length()>0 && npassword.length()>0 && nemail.length()>0){ 
            ...
            try{
            	...
            	funciones.modificarAlumno(ndni,nnombre, napellidos, nusername, npermisos, npassword,nemail);
                
                //new Usuario().setVisible(true);
                BiblioModiAlumno1.this.dispose();
