...
public class BiblioModiProfe1 extends JFrame {
  ...
  public static void main(String[] args) {
    EventQueue.invokeLater(new Runnable() {
      public void run() {
        try {
        	BiblioModiProfe1 frame = new BiblioModiProfe1();
   ...
   * Create the frame.
   */
  public BiblioModiProfe1() {
    
    try{
      String[] datos = funciones.getProfe(BiblioModiProfe.ndni);
      ...
      label_2.addMouseListener(new MouseAdapter() {
        ...
        public void mouseClicked(MouseEvent e) {
          ...
          BiblioModiProfe1.this.dispose(); //hago "invisible la clase login"
        }
      });
      ...
      dnis.setText(BiblioModiProfe.ndni);
