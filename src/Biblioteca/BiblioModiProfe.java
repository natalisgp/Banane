...
public class BiblioModiProfe extends JFrame {
  ...
  public static void main(String[] args) {
    EventQueue.invokeLater(new Runnable() {
      public void run() {
        try {
        	BiblioModiProfe frame = new BiblioModiProfe();
  ...
  public BiblioModiProfe() {
    ...
    label_2.addMouseListener(new MouseAdapter() {
      ...
      public void mouseClicked(MouseEvent e) {
        ...
        BiblioModiProfe.this.dispose(); //hago "invisible la clase login"
      }
    });
    ...
    btnEliminar.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        ...
        if(ndni.length()>0){ // y exista dicho dni
          ...
          try{
            String[] usuario = funciones.getProfe(ndni);
            
            if(ndni.equals(usuario[2])){
              
              new BiblioModiProfe1().setVisible(true);
              BiblioModiProfe.this.dispose();
              System.out.println("Voy a modificar los datos de un profesor");
    ...
    JLabel lblModificarUsuario = new JLabel("Modificar datos del profesor");
    ...
    button.setBorderPainted(false);  		button.addActionListener(new ActionListener() {
    		      public void actionPerformed(ActionEvent e) {
