...
public class ModificarProfe1 extends JFrame {
  ...
  public static void main(String[] args) {
    EventQueue.invokeLater(new Runnable() {
      public void run() {
        try {
        	ModificarProfe1 frame = new ModificarProfe1();
   ...
   * Create the frame.
   */
  public ModificarProfe1() {
    
    try{
      String[] datos = funciones.getProfe(ModificarProfe.ndni);
      ...
      label_2.addMouseListener(new MouseAdapter() {
        ...
        public void mouseClicked(MouseEvent e) {
          new ModificarProfe().setVisible(true);
          ModificarProfe1.this.dispose(); //hago "invisible la clase login"
        }
      });
      ...
      dnis.setText(ModificarProfe.ndni);
      
      JLabel lblEliminarUsuario = new JLabel("Modificar datos del profesor");
        ...
        public void actionPerformed(ActionEvent e) {
          ...
          if(nnombre.length()>0 && napellidos.length()>0 && nusername.length()>0 && npermisos.length()>0 && npassword.length()>0 && nemail.length()>0){ 
            ...
            try{
            	...
            	funciones.modificarProfe(ndni,nnombre, napellidos, nusername, npermisos, npassword,nemail);
                
                //new Usuario().setVisible(true);
            	ModificarProfe1.this.dispose();
