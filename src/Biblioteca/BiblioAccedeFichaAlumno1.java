...
public class BiblioAccedeFichaAlumno1 extends JFrame {
  ...
  public static void main(String[] args) {
    EventQueue.invokeLater(new Runnable() {
      public void run() {
        try {
          BiblioAccedeFichaAlumno1 frame = new BiblioAccedeFichaAlumno1();
   ...
   * Create the frame.
   */
  public BiblioAccedeFichaAlumno1() {
    
    try{
      String[] datos = funciones.getAlumno(BiblioAccedeFichaAlumno.ndni);
      ...
      label_2.addMouseListener(new MouseAdapter() {
        ...
        public void mouseClicked(MouseEvent e) {
          ...
          BiblioAccedeFichaAlumno1.this.dispose(); //hago "invisible la clase login"
        }
      });
      ...
      dnis.setText(BiblioAccedeFichaAlumno.ndni);
      
      JLabel lblEliminarUsuario = new JLabel("Ver datos del alumno");
