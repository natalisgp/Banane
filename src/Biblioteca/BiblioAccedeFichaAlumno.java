...
public class BiblioAccedeFichaAlumno extends JFrame {
  ...
  public static void main(String[] args) {
    EventQueue.invokeLater(new Runnable() {
      public void run() {
        try {
          BiblioAccedeFichaAlumno frame = new BiblioAccedeFichaAlumno();
   ...
   * Create the frame.
   */
  public BiblioAccedeFichaAlumno() {
    ...
    label_2.addMouseListener(new MouseAdapter() {
      ...
      public void mouseClicked(MouseEvent e) {
        ...
        BiblioAccedeFichaAlumno.this.dispose(); //hago "invisible la clase login"
      }
    });
        ...
        if(ndni.length()>0){ // y exista dicho dni
          ...
          try{
            ...
            if(ndni.equals(usuario[2])){
              ...
              new BiblioAccedeFichaAlumno1().setVisible(true);
              BiblioAccedeFichaAlumno.this.dispose();
