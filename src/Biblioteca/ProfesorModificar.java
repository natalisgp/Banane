...
public class ProfesorModificar extends JFrame {
  ...
  public static void main(String[] args) {
    EventQueue.invokeLater(new Runnable() {
      public void run() {
        try {
        	ProfesorModificar frame = new ProfesorModificar();
  ...
  public ProfesorModificar() {
    ...
    try{
      String[] datos = funciones.getProfe(login.ndni);
      ...
      label_2.addMouseListener(new MouseAdapter() {
        ...
        public void mouseClicked(MouseEvent e) {
          ...
          ProfesorModificar.this.dispose(); //hago "invisible la clase login"
        }
      });
        ...
        public void actionPerformed(ActionEvent e) {
          ...
          if(nnombre.length()>0 && napellidos.length()>0 && nusername.length()>0 && npermisos.length()>0 && npassword.length()>0 && nemail.length()>0){ 
            ...
            try{
            	...
            	ProfesorModificar.this.dispose();
