...
public class DarDeBajaA extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DarDeBajaA frame = new DarDeBajaA();
	...
	public DarDeBajaA() {
		...
		label_2.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DarDeBajaA.this.dispose(); //hago "invisible la clase login"
		...
		JLabel lblEliminarUsuario = new JLabel("Dar de baja alumno");
