...
public class BiblioAccedeFichaProfe1 extends JFrame {
  ...
  public static void main(String[] args) {
    EventQueue.invokeLater(new Runnable() {
      public void run() {
        try {
        	BiblioAccedeFichaProfe1 frame = new BiblioAccedeFichaProfe1();
   ...
   * Create the frame.
   */
  public BiblioAccedeFichaProfe1() {
    
    try{
      String[] datos = funciones.getProfe(BiblioAccedeFichaProfe.ndni);
      ...
      label_2.addMouseListener(new MouseAdapter() {
        ...
        public void mouseClicked(MouseEvent e) {
          ...
          BiblioAccedeFichaProfe1.this.dispose(); //hago "invisible la clase login"
        }
      });
      ...
      dnis.setText(BiblioAccedeFichaProfe.ndni);
