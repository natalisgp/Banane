...
public class EliminarLibro extends JFrame {
	...
	public EliminarLibro() {
		...
		JLabel lblEliminarUsuario = new JLabel("Eliminar libro");
		...
		btnEliminar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(ndni.length()>0){ // y exista dicho dni
					...
					try{
						String[] comprobar = funciones.getLibros(ndni);
						...
						if(ndni.equals(comprobar[4])){
							...
							System.out.println("Voy a eliminar el libro");
							funciones.removeLibro(ndni);
