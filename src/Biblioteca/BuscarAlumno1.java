...
public class BuscarAlumno1 extends JFrame {
  ...
  public static void main(String[] args) {
    EventQueue.invokeLater(new Runnable() {
      public void run() {
        try {
        	BuscarAlumno1  frame = new BuscarAlumno1();
  ...
  public BuscarAlumno1() {
    ...
    try{
      String[] datos = funciones.getAlumno(BuscarAlumno.ndni);
      ...
      label_2.addMouseListener(new MouseAdapter() {
        ...
        public void mouseClicked(MouseEvent e) {
          ...
          BuscarAlumno1.this.dispose(); //hago "invisible la clase login"
        }
      });
      ...
      dnis.setText(BuscarAlumno.ndni);
