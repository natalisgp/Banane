...
public class AnadirElegir extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AnadirElegir frame = new AnadirElegir();
	...
	public AnadirElegir() {
		...
		label_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
					...
					AnadirElegir.this.dispose(); //hago "invisible la clase login"
		...
		JLabel lblAdministrador = new JLabel("Elegir usuario");
		...
		btnModificarDatosUsuario.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				new AnadirProfe().setVisible(true);
				AnadirElegir.this.dispose();
