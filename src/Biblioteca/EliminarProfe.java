...
public class EliminarProfe extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EliminarProfe frame = new EliminarProfe();
	...
	public EliminarProfe() {
		...
		label_2.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				EliminarProfe.this.dispose(); //hago "invisible la clase login"
		...
		JLabel lblEliminarUsuario = new JLabel("Eliminar profesor");
				...
				if(ndni.length()>0){ // y exista dicho dni
					...
					try{
						...
						if(ndni.equals(comprobar[2])){
							...
							//new ().setVisible(true);
							EliminarProfe.this.dispose();
							System.out.println("Voy a eliminar al profesor");
