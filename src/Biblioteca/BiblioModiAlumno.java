...
public class BiblioModiAlumno extends JFrame {
  ...
  public static void main(String[] args) {
    EventQueue.invokeLater(new Runnable() {
      public void run() {
        try {
          BiblioModiAlumno frame = new BiblioModiAlumno();
  ...
  public BiblioModiAlumno() {
    ...
    label_2.addMouseListener(new MouseAdapter() {
      ...
      public void mouseClicked(MouseEvent e) {
        ...
        BiblioModiAlumno.this.dispose(); //hago "invisible la clase login"
      }
    });
        ...
        if(ndni.length()>0){ // y exista dicho dni
          ...
          try{
            ...
            if(ndni.equals(usuario[2])){
              ...
              new BiblioModiAlumno1().setVisible(true);
              BiblioModiAlumno.this.dispose();
              System.out.println("Voy a modificar los datos de un alumno");
    ...
    JLabel lblModificarUsuario = new JLabel("Modificar datos del alumno");
