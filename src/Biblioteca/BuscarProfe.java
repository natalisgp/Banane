...
public class BuscarProfe extends JFrame {
  ...
  public static void main(String[] args) {
    EventQueue.invokeLater(new Runnable() {
      public void run() {
        try {
        	BuscarProfe frame = new BuscarProfe();
  ...
  public BuscarProfe() {
    ...
    label_2.addMouseListener(new MouseAdapter() {
      ...
      public void mouseClicked(MouseEvent e) {
        ...
        BuscarProfe.this.dispose(); //hago "invisible la clase login"
      }
    });
        ...
        if(ndni.length()>0){ // y exista dicho dni
          ...
          try{
            ...
            if(ndni.equals(usuario[2])){
              ...
              new BuscarProfe1().setVisible(true);
              BuscarProfe.this.dispose();
