...
public class BiblioAccedeFichaProfe extends JFrame {
  ...
  public static void main(String[] args) {
    EventQueue.invokeLater(new Runnable() {
      public void run() {
        try {
        	BiblioAccedeFichaProfe frame = new BiblioAccedeFichaProfe();
  ...
  public BiblioAccedeFichaProfe() {
    ...
    label_2.addMouseListener(new MouseAdapter() {
      ...
      public void mouseClicked(MouseEvent e) {
        ...
        BiblioAccedeFichaProfe.this.dispose(); //hago "invisible la clase login"
      }
    });
        ...
        if(ndni.length()>0){ // y exista dicho dni
          ...
          try{
            ...
            if(ndni.equals(usuario[2])){
              ...
              new BiblioAccedeFichaProfe1().setVisible(true);
              BiblioAccedeFichaProfe.this.dispose();
              System.out.println("Voy a ver los datos de un profesor");
    ...
    JLabel lblModificarUsuario = new JLabel("Acceder ficha del profesor");
